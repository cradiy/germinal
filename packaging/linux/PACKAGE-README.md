...
The binary dynamically links to Fontconfig and FreeType. A Vulkan-capable, OpenGL-capable, or
software WGPU backend must also be available.
...
Fontconfig and FreeType on the destination system. DEB, RPM, and Arch Linux outputs intentionally
remain glibc packages.
