...
impl WgpuTerminalGlyphAtlasBindGroupFactory {
	pub fn new() -> Self { Self { spec: WgpuTerminalGlyphAtlasBindGroupSpec::new() } }

	pub fn with_spec(spec: WgpuTerminalGlyphAtlasBindGroupSpec) -> Self { Self { spec } }

	pub fn spec(&self) -> WgpuTerminalGlyphAtlasBindGroupSpec { self.spec }
...
mod tests {
	...
	fn default_spec_uses_fragment_texture_and_sampler_bindings() {
		...
		assert_eq!(spec.sampler_binding_type, wgpu::SamplerBindingType::Filtering);
	}
