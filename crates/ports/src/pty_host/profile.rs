...
impl TerminalProfile {
	pub const DEFAULT: Self =
		Self { font_config: TerminalFontConfig::DEFAULT, size_config: TerminalSizeConfig::DEFAULT };
	...
	pub const fn new(
		...
		Self { font_config: TerminalFontConfig::new(font_family, font_size), size_config }
	}

	pub const fn font_config(self) -> TerminalFontConfig { self.font_config }

	pub const fn font_family(self) -> TerminalFontFamily { self.font_config.family() }
