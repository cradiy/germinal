...
impl TerminalPadding {
    ...
    pub const fn new(x_px: u32, y_px: u32) -> Self {
        Self { x_px, y_px }
    }
...
impl TerminalSizeInfo {
    ...
    pub const fn pty_size(self) -> TerminalPtySize {
        self.pty_size
    }

    pub fn content_width_px(self) -> u32 {
        self.content_size.width_px()
    }

    pub fn content_height_px(self) -> u32 {
        self.content_size.height_px()
    }
    ...
    pub fn is_consistent(self) -> bool {
        ...
        let expected_pty_size =
            TerminalPtySize::from_content_pixels(self.content_size, self.cell_size);
